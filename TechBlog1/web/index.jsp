...
<div class="row"> 
  <div class="col-sm-2">
  <a href="search.html" style="text-decoration: none">  <img src="image/AI.png" style="width:100%"><h4> <Center>Artificial Intelligence</center></h4> </a>
    
    
  </div>
  <div class="col-sm-2">
  <a href="search.html" style="text-decoration: none">  <img src="image/communication.png" style="width:100%"><h4> <Center>Communication</center></h4> </a>
    
  </div>  
  <div class="col-sm-2">
  <a href="search.html" style="text-decoration: none">  <img src="image/humanoid.png" style="width:100%"> <h4> <Center>Humanoid</center></h4></a>
    
  </div>
  <div class="col-sm-2">
  <a href="search.html" style="text-decoration: none">  <img src="image/ITE.png" style="width:100%"> <h4> <Center>IT and Education</center></h4></a>
    
  </div>
   <div class="col-sm-2">
  <a href="search.html" style="text-decoration: none">  <img src="image/quantum.png" style="width:100%"> <h4> <Center>Quantum Computing</center></h4></a>
    
    
  </div>
  <div class="col-sm-2">
  <a href="search.html" style="text-decoration: none">  <img src="image/robotics.png" style="width:100%"> <h4> <Center>Robotics</center></h4></a>
